...
cfg.AUG.COLOR_JITTER_PROB = 0.0
# random rotate
cfg.AUG.ROTATE = False

cfg.AUG.RANDOM_SCALE = (0.7, 1.3)
########################### train config ##########################################
# epochs
cfg.TRAIN.EPOCHS = 30
# batch size
...
# train crop size
cfg.TRAIN.CROP_SIZE = 256
# train base size
cfg.TRAIN.BASE_SIZE = 256
# model output dir
cfg.TRAIN.MODEL_SAVE_DIR = 'runs/checkpoints/'
# log dir
cfg.TRAIN.LOG_SAVE_DIR = 'runs/checkpoints/'
...
cfg.TRAIN.MODEL_PRETRAINED_PATH = ''
# resume model path
