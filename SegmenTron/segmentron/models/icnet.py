...
class ICNet(SegBaseModel):
    ...
    def __init__(self):
        ...
        self.head = _ICHead(8)
        self.head2 = _ICHead(14)

        self.supervise_size = int(cfg.TRAIN.SUPERVISE_SIZE)
        self.__setattr__('decoder', ['conv_sub1', 'head', 'head2'])
    ...
    def forward(self, x):
        ...
        outputs1 = self.head(x_sub1, x_sub2, x_sub4, size)
        outputs2 = self.head2(x_sub1, x_sub2, x_sub4, size)
