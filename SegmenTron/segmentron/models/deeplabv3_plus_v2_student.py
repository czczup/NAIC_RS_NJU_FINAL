...
__all__ = ['DeepLabV3PlusV2Student']


@MODEL_REGISTRY.register(name='DeepLabV3_Plus_V2_Student')
class DeepLabV3PlusV2Student(SegBaseModel):
    r"""DeepLabV3Plus
    Reference:
    ...
    """
    def __init__(self):
        super(DeepLabV3PlusV2Student, self).__init__()
