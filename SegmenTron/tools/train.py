...
class Trainer(object):
    ...
    def validation(self, epoch):
        ...
        synchronize()
        if self.best_pred < fwiou and self.save_to_disk:
            self.best_pred = fwiou
            logging.info('Epoch {} is the best model, best pixAcc: {:.3f}, FWIoU: {:.3f}, save the model..'.format(epoch, pixAcc * 100, fwiou * 100))
